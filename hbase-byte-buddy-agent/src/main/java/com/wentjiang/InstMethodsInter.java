...
public class InstMethodsInter {
    ...
    public InstMethodsInter(String instanceMethodsAroundInterceptorClassName, ClassLoader classLoader) {
        System.out.println("init InstMethodsInter");
        try {
            System.out.println("class loader in interceptor: " + classLoader.getName());
            Class clazz = Class.forName(instanceMethodsAroundInterceptorClassName);
    ...
    public Object intercept(@This Object obj,
        ...
        try {
            interceptor.beforeMethod(method, allArguments, method.getParameterTypes());
        } catch (Throwable t) {
